...
// 
// Generated using ACDS version 13.1 162 at 2015.01.08.16:13:34
...
module mysystem_mm_interconnect_0 (
	...
	wire          rsp_xbar_mux_src_endofpacket;                                                // rsp_xbar_mux:src_endofpacket -> Arm_A9_HPS_h2f_axi_master_agent:write_rp_endofpacket
	wire          rsp_xbar_mux_src_valid;                                                      // rsp_xbar_mux:src_valid -> Arm_A9_HPS_h2f_axi_master_agent:write_rp_valid
	wire          rsp_xbar_mux_src_startofpacket;                                              // rsp_xbar_mux:src_startofpacket -> Arm_A9_HPS_h2f_axi_master_agent:write_rp_startofpacket
	wire  [232:0] rsp_xbar_mux_src_data;                                                       // rsp_xbar_mux:src_data -> Arm_A9_HPS_h2f_axi_master_agent:write_rp_data
	wire    [1:0] rsp_xbar_mux_src_channel;                                                    // rsp_xbar_mux:src_channel -> Arm_A9_HPS_h2f_axi_master_agent:write_rp_channel
	wire          rsp_xbar_mux_src_ready;                                                      // Arm_A9_HPS_h2f_axi_master_agent:write_rp_ready -> rsp_xbar_mux:src_ready
	wire          rsp_xbar_mux_001_src_endofpacket;                                            // rsp_xbar_mux_001:src_endofpacket -> Arm_A9_HPS_h2f_axi_master_agent:read_rp_endofpacket
	wire          rsp_xbar_mux_001_src_valid;                                                  // rsp_xbar_mux_001:src_valid -> Arm_A9_HPS_h2f_axi_master_agent:read_rp_valid
	wire          rsp_xbar_mux_001_src_startofpacket;                                          // rsp_xbar_mux_001:src_startofpacket -> Arm_A9_HPS_h2f_axi_master_agent:read_rp_startofpacket
	wire  [232:0] rsp_xbar_mux_001_src_data;                                                   // rsp_xbar_mux_001:src_data -> Arm_A9_HPS_h2f_axi_master_agent:read_rp_data
	wire    [1:0] rsp_xbar_mux_001_src_channel;                                                // rsp_xbar_mux_001:src_channel -> Arm_A9_HPS_h2f_axi_master_agent:read_rp_channel
	wire          rsp_xbar_mux_001_src_ready;                                                  // Arm_A9_HPS_h2f_axi_master_agent:read_rp_ready -> rsp_xbar_mux_001:src_ready
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_agent_write_cp_data;                               // Arm_A9_HPS_h2f_axi_master_agent:write_cp_data -> addr_router:sink_data
	...
	wire  [232:0] arm_a9_hps_h2f_axi_master_agent_read_cp_data;                                // Arm_A9_HPS_h2f_axi_master_agent:read_cp_data -> addr_router_001:sink_data
